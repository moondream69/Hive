...
![1](Hive%203.1.2.assets/image-20221008085321738.png)
...
![image-20221008085609418](Hive%203.1.2.assets/image-20221008085609418.png)

Hive本质是将SQL转换为MapReduce的任务进行运算，底层由HDFS来提供数据存储

思考：计算文件user.txt中张三出现几次，使用mapreduce怎么写，然后再比照下图的hive的实现过程

![image-20221008090227089](Hive%203.1.2.assets/image-20221008090227089.png)
...
- 初始化数据库
  ...
  - ![image-20221019144100088](Hive%203.1.2.assets/image-20221019144100088.png)
  - ![image-20221019144344979](Hive%203.1.2.assets/image-20221019144344979.png)
- 启动Hive
...
![image-20221012084002162](Hive%203.1.2.assets/image-20221012084002162.png)
...
- 函数必须实现以下5个方法，方法说明：
  ...
  - ![10086112-612ce3dadda97020.png](Hive%203.1.2.assets/10086112-612ce3dadda97020.png)
...
- SequenceFile：
  ...
  - SenquenceFile的文件结构图：
    ...
    ![image-20221111015049762](Hive%203.1.2.assets/image-20221111015049762.png)
...
- Block-Compressed SequenceFile格式
  ...
  ![image-20221111015951548](Hive%203.1.2.assets/image-20221111015951548.png)
